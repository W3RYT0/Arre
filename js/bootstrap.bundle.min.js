...
!(function (t, e) {
  ...
  function ae(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (("body" !== ht(e) || Vt(a)) && (c = (n = e) !== dt(n) && ft(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : Ut(n)), ft(e) ? (((h = bt(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = $t(a))),
  ...
  class Te extends H {
    ...
    _getConfig(t) {
      if (
        ((t = { ...this.constructor.Default, ...F.getDataAttributes(this._element), ...t }), r("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !s(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
      )
